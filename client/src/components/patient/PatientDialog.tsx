...
const PatientDialog: React.FC<PatientDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-full max-w-2xl mx-auto p-2 sm:p-6 flex flex-col overflow-hidden">
        <DialogHeader className="flex flex-col sm:flex-row items-center justify-between gap-2">
          <DialogTitle>
